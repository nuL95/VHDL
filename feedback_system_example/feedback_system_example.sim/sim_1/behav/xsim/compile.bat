...
REM
REM Generated by Vivado on Sun Jan 26 10:26:12 -0800 2025
...
echo "xvhdl --incr --relax -prj fb_sys_tb_vhdl.prj"
call xvhdl  --incr --relax -prj fb_sys_tb_vhdl.prj -log xvhdl.log
