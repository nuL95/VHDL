...
REM
REM Generated by Vivado on Thu Jan 16 19:27:07 -0800 2025
...
echo "xvhdl --incr --relax -prj silly_tb_vhdl.prj"
call xvhdl  --incr --relax -prj silly_tb_vhdl.prj -log xvhdl.log
