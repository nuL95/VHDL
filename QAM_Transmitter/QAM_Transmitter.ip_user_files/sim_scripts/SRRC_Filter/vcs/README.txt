...
#
# Generated by export_simulation on Wed Jan 22 15:17:18 -0800 2025
#
################################################################################
...
'-reset_run' switch to the './SRRC_Filter.sh' script.

./SRRC_Filter.sh -reset_run
...
./SRRC_Filter.sh -noclean_files

For more information on the script, please type './SRRC_Filter.sh -help'.
