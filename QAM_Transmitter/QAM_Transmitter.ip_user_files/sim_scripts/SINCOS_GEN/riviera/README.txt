...
#
# Generated by export_simulation on Thu Jan 23 10:40:54 -0800 2025
#
################################################################################
...
'-reset_run' switch to the './SINCOS_GEN.sh' script.

./SINCOS_GEN.sh -reset_run
...
./SINCOS_GEN.sh -noclean_files

For more information on the script, please type './SINCOS_GEN.sh -help'.
