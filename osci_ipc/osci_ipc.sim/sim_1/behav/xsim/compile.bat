...
REM
REM Generated by Vivado on Wed Jan 15 12:24:06 -0800 2025
...
echo "xvhdl --incr --relax -prj osci_ipc_tb_vhdl.prj"
call xvhdl  --incr --relax -prj osci_ipc_tb_vhdl.prj -log xvhdl.log
