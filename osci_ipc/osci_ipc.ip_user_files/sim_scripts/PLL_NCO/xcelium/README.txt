...
#
# Generated by export_simulation on Wed Jan 29 13:18:31 -0800 2025
#
################################################################################
...
'-reset_run' switch to the './PLL_NCO.sh' script.

./PLL_NCO.sh -reset_run
...
./PLL_NCO.sh -noclean_files

For more information on the script, please type './PLL_NCO.sh -help'.
