...
REM
REM Generated by Vivado on Fri Jan 10 15:42:16 -0800 2025
...
echo "xvhdl --incr --relax -prj Behav_Sim_vhdl.prj"
call xvhdl  --incr --relax -prj Behav_Sim_vhdl.prj -log xvhdl.log
